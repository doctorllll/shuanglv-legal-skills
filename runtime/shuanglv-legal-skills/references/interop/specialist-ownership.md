# Interop｜Specialist Ownership

`unit_id: unit.interop.specialist`

**Scope：** Specialist primary ownership and generalist integration boundary.

## Trigger
- A narrower Specialist exists or cross-skill ownership must be decided.

## Negative Trigger
- Single-skill task with clear owner.
...
- Multiple specialists or cross-domain integration.

## Exit Sufficiency
- One clear ownership model without duplicate full-method loading.

## Professional Results
- primary/advisory ownership decision
