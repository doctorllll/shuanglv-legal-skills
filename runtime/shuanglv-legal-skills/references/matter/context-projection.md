...
## Essential Procedure
1. Select only current subtask-relevant source/results/decisions/open issues.
...
Required: `matter_id`, `matter_label`, `current_goal`, `last_material_directive`, `current_stage`, `current_result_refs`, `stale_result_refs`, `open_issue_refs`, `decision_refs`, `recent_source_changes`, `recommended_next_units`, `generated_at`
